...
/** Sorted two gametes from one parent (axis); order of the two rows/cols does not matter. */
...
/**
 * Canonical signature: unordered pair of parent gamete-pairs + sorted offspring genotypes.
 * Treats swapping which parent is on the row vs column as equivalent (same biology).
 */
...
/** Match user tables to key tables (same length); table order does not matter. */
